...
class VolumeBasicHelper(CephFSTestCase):
    ...
    TEST_FILE_NAME_PREFIX = "subvol_file"
...
class VolumeHelper(VolumeBasicHelper):
    '''
    ...
    def tearDown(self):
        ...
        super(VolumeHelper, self).tearDown()
