...
class CephCluster(RunCephCmd):
    ...
    def __init__(self, ctx) -> None:
        ...
        self._ctx = ctx
        self.mon_manager = ceph_manager.CephManager(self.admin_remote,
            ctx=ctx, logger=log.getChild('ceph_manager'))
...
class MDSCluster(CephCluster):
    ...
    def get_mds_info(self, mds_id):
        return FSStatus().get_mds(mds_id)
