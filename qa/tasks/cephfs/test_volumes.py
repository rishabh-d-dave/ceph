...
class TestVolumesHelper(CephFSTestCase):
    ...
    def __check_clone_state(self, state, clone, clone_group=None,
        ...
        while count < max_count:
            ...
            if result["status"]["state"] in state:
                return
        ...
        raise WrongCloneStatus(f'Executed cmd "{args}" {max_count} times. '
                               f'Clone was never in "{state}" state(s).')
...
class TestCloneProgress(TestVolumesHelper):
    ...
    def _loop_cmd(self, cmdargs):
        ...
        while True:
            ...
            if p.exitstatus == 11:
                i = i + 1
                if i == 50:
                    raise RuntimeError('Command "{cmdargs}" failed 50 times.')
                time.sleep(2)
                continue
            elif p.exitstatus == 0:
                return p
    ...
    def test_progress_bar_for_1_clone(self):
        ...
        while p < 1.0:
            try:
                ...
                raise Exception('Didn\'t find expected entries in dictionary '
    ...
    def test_progress_bars_for_7_clones(self):
        ...
        while p1 < 1.0 and p2 < 1.0:
            ...
            v1, v2 = pevs.values()
            if 'ongoing cloning jobs' in v1['message']:
