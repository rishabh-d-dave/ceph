...
class TestFSFail(TestAdminCommands):
    ...
    def test_with_health_warn_oversize_cache(self):
        ...
        self.config_set('mds', 'mds_cache_memory_limit', '4Gi')
        self.config_set('mds', 'mds_health_cache_threshold', '1.5')
    ...
    def test_with_health_warn_with_2_active_MDSs(self):
        ...
        mds1_id, mds2_id = self.fs.mds_ids
        self.fs.wait_for_daemons()
...
class TestMDSFail(TestAdminCommands):
    ...
    def test_with_health_warn_with_2_active_MDSs(self):
        ...
        if mds1_id == hw_mds_id:
            ...
            raise RuntimeError(
                'There are only 2 MDSs right now but apparently health '
                'warning was raised for an MDS other than these two. This '
