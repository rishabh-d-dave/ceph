...
class RmtreeDir:
    ...
    def add_dir_to_stack(self, de_path, de_name):
        ...
        try:
            ...
            return 'break'
        # opendir() called in RmtreeDir.__init__() through call to
        # RmtreeDir.try_opendir() failed, most likely because permission for
        # de_path is not granted. Skip it and proceed deleting rest of files
