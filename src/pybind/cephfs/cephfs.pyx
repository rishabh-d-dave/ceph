...
cdef class LibCephFS(object):
    ...
    def __add_dir_to_stack(self, de_name, stack, curr_dir,
        ...
        try:
            stack.append(RmtreeDir(de_path, self, suppress_errors))
    ...
    def __notify_parent_dir(self, stack, curr_dir):
        ...
        try:
            ...
            stack[-2].add_to_de_ignore_list(curr_dir.name.encode('utf-8'))
        except IndexError:
            pass
    ...
    def _rmtree(self, trash_path, should_cancel, suppress_errors=False):
        try:
            ...
            # inside this method).
            stack = deque([])
            stack.append(RmtreeDir(trash_path, self, suppress_errors))
        except Exception as e:
                ...
                if de.is_dir():
                    try:
                        ...
                        retval = self.__add_dir_to_stack(de_name, stack, curr_dir,
                                                         suppress_errors)
                elif de.is_file() or de.is_symbol_file():
