...
class PurgeProgressBar(VolumesProgressBar):
    ...
    def _update_progress_bars(self):
        ...
        files_purged = self.init_file_count - file_count
        # if files_purged is less than zero, it means rstats were update and/or
        # more subvolumes were deleted. int that case update init_file_count and
        # init_subvol_count
        if files_purged < 0:
            laggy_note = 'Note: MDS rstats are laggy.'
