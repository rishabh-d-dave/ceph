...
from subprocess import getoutput as shell_cmd_output
...
def setup_module():
    global cephfs, uid, gid
    cephfs = libcephfs.LibCephFS(conffile='')

    username = shell_cmd_output('id -un')
    uid = shell_cmd_output(f'id -u {username}')
    gid = shell_cmd_output(f'id -g {username}')
